    ...
    return (
        <div className="w-11/12 mx-auto">
            ...
            <Tabs defaultValue="all" className="w-full">
                <TabsList className={`grid w-full grid-cols-6 justify-start h-12 bg-transparent border-b rounded-none`}>
                    {tabs.map((tab, idx) => (
                        <TabsTrigger
            ...
            {!isLoading && meta && (
                <div className="flex items-center justify-between mt-6">
                    <p>Showing {orders.length} of total {meta.total}</p>
                    <div>
                        <Pagination>
                            <PaginationContent>
                                <PaginationItem>
                                ...
                                <PaginationItem>
                                    <PaginationNext
                                        href="#"
                                        onClick={() => setPage(page === meta.totalPages ? meta.totalPages : page + 1)}
                                    />
                                </PaginationItem>
                            </PaginationContent>
                        </Pagination>
