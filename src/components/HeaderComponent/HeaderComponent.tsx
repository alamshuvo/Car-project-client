  ...
  return (
    <div className="relative flex items-center justify-between h-[400px]">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${AbstractSphere})`,
      ...
      <div className="relative z-10">
        <h2 className="text-5xl font-bold uppercase md:text-7xl text-blue-950">
          Unlock your <MapPin className="inline text-red-500" size={80} />{" "}
          <br /> travel experience
        </h2>
        <p className="max-w-xl my-4 text-white md:text-gray-600 md:my-8 ">
          Lorem ipsum dolor sit amet consectetur. Sagittis augue odio enim lorem
          tellus. Lorem ipsum dolor sit amet consectetur. Sagittis augue odio
          enim lorem tellus.
        </p>
        <Link to="/products">
      ...
      <img
        className="absolute right-0 blur-sm md:blur-0"
        src={CarImage}
        alt=""
      />
    </div>
