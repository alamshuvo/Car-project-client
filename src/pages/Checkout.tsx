    ...
    const handleBillingSubmit: SubmitHandler<FieldValues> = async (data) => {
        ...
        try {
            ...
            if (orderResponse.error) {
                ...
                const paymentResponse = await initiatePayment(orderResponse.data?.orderId)
    ...
    return (
        <div className="w-full py-12 mb-12 space-y-4 rounded bg-gray-50">
            <div className="max-w-4xl px-6 mx-auto">
                ...
                <FormComponent defaultValues={defaultValues} onSubmit={handleBillingSubmit}
                    resolver={zodResolver(billingAddressValidationSchema)}>
                    <h3 className="my-2 text-xl">Enter your shipping address:</h3>
                    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                        <FormInput name='customerName' type='text' label='Enter Name' placeholder='' />
                        <FormInput name='customerAddress' type='text' label='Enter Address' placeholder='' />
                        <FormInput name='customerPhone' type='text' label='Enter Phone' placeholder='' />
                        <FormInput name='customerCity' type='text' label='Enter City' placeholder='' />
                        <FormInput name='customerPostCode' type='text' label='Enter PostCode' placeholder='' />
                    </div>
