...
const CreateProduct = () => {
  const defaultValues = {
    ...
    stock: 15,
    description:
      "The all-new Honda Civic combines exceptional comfort with outstanding performance. Features include advanced safety technologies, premium interior design, and excellent fuel efficiency.",
    category: "sedan",
    images: [
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    ...
    try {
      ...
      if (res.error) {
        ...
        toast.success(res.message || "New product created successfully!", {
          id: loadingToast,
        });
      }
    } catch (err) {
