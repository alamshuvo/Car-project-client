...
const EditProduct = () => {
  ...
  const { data: carDataResponse, isLoading } = useGetSingleProductQuery({
    productId,
  });
  ...
  const handleProductUpdateSubmit: SubmitHandler<FieldValues> = async (
    data,
  ) => {
    // console.log(data);
  ...
  return isLoading ? (
    ...
    <FormComponent
      ...
      defaultValues={carDataResponse?.result}
    >
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="w-full p-6 mx-auto space-y-4 bg-white rounded-lg shadow-lg">
